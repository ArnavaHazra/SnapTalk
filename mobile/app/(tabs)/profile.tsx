          ...
          <View className="px-4 pb-4 border-b border-gray-100">
            <View className="flex-row justify-between items-end -mt-16 mb-4">
              <Image 
                ...
                className="size-32 rounded-full border-4 border-slate-100"
              /> 
              <TouchableOpacity 
            ...
            <View className="mb-4">
                ...
                <View className="flex-row items-center mb-2">
                  <Feather name="map-pin" size={16} color={"#85778"}/>
                  <Text className="text-gray-500 ml-2 font-semibold">
                    {currentUser.location} India
                  </Text>
                </View>

                <View className="flex-row items-center mb-3">
                  <Feather name="calendar" size={16} color={"#85778"}/>
                  <Text className="text-gray-500 ml-2 font-semibold">
                ...
                <View className="flex-row">
                   <TouchableOpacity className="mr-6">
                      <Text className="text-gray-900">
                        ...
                        <Text className="text-gray-500 font-semibold"> Following</Text>
                      </Text>
                    </TouchableOpacity>
                    <TouchableOpacity>
                      <Text className="text-gray-900">
                        <Text className="font-bold">{currentUser.followers?.length}</Text>
                        <Text className="text-gray-500 font-semibold"> Followers</Text>
                      </Text>
                    </TouchableOpacity>
                </View>
