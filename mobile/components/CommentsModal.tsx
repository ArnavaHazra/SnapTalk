  ...
  return (
    <Modal visible={!!selectedPost} animationType="slide" presentationStyle="pageSheet">
      ...
      <View className="flex-row items-center justify-between px-4 py-3 border-b border-gray-100">
        <TouchableOpacity onPress={handleClose} className="bg-slate-200 ml-1 px-2 py-2 rounded-xl">
            ...
            <View className="flex-row">
              ...
              <View className="flex-1">
                <View className="flex-row items-center mb-1">
                  ...
                  <Text className="text-gray-500 ml-1 font-semibold">@{selectedPost.user.username}</Text>
                </View>
              ...
              <View className="flex-row">
                ...
                <View className="flex-1">
                  <View className="flex-row items-center mb-1">
                    ...
                    <Text className="text-gray-500 text-sm ml-1 font-semibold">@{comment.user.username}</Text>
                  </View>
